...
export default function Services() {
  ...
  return (
    <motion.div
      className="bg-white py-20 px-6 mt-20"
      ...
      <div className="bg-gray-900 py-2 px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-20">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="bg-gray-800 text-gray-100 rounded-2xl shadow-lg p-6 text-center transform transition duration-500 hover:scale-105 hover:shadow-blue-500/40 hover:bg-gray-800"
            >
